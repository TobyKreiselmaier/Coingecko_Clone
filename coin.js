...
function generateListElements(data) {
  ...
  $('#coinList').append(
    ...
    $('<li class="list-group-item"></li>').html("Description: " + data.description.en),
    $('<li class="list-group-item"></li>').html("Homepage: " + data.links.homepage[0].link(data.links.homepage[0])),
